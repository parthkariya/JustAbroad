...
import "./Ieltstakequizelesson.css";
...
const Ielts_TakeQuizeLesson = ({ getlistinner4 }) => {
  ...
  const SkillQuiz = async (id, answer) => {
    ...
    axios
      .post(improvement_quiz, formdata, {
        headers: {
...
export default Ielts_TakeQuizeLesson;
