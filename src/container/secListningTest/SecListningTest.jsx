...
const SecListningTest = ({ getListning }) => {
        ...
        <div style={{ display: "flex", gap: "1rem", flexDirection: "column" }}>
          <div className="SectionTest_content_data_main">
            <div className="secTest_name_head">
              <h5>{getListning ? getListning.listening_name : ""}</h5>
            </div>
            <div className="SectionTest_content_data_num_main">
              <div className="SectionTest_content_data_num_inner">
                <div>{getListning ? getListning.total_que : ""}</div>
                <div>Total</div>
              </div>
              <div className="verticle_line"></div>
              <div className="SectionTest_content_data_num_inner">
                <div>{getListning ? getListning.attempt : ""}</div>
                <div>Attempts</div>
              </div>
              <div className="verticle_line"></div>
              <div className="SectionTest_content_data_num_inner">
                <div>{getListning ? getListning.correct : ""}</div>
                <div>Correct</div>
              </div>
              <div className="verticle_line"></div>
...
export default SecListningTest;
