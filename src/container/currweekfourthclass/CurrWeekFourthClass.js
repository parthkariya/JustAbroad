...
const CurrWeekFourthClass = ({ getSpeaking }) => {
        ...
        <div style={{ display: "flex", gap: "1rem", flexDirection: "column" }}>
          ...
          <div className="SectionTest_content_data_main">
            <div className="secTest_name_head">
              <h5>
                {getSpeaking ? getSpeaking.curriculum_listening_name : ""}
              </h5>
              {/* <h5>Listening - Fill in the Blanks - (C.W - 4 D - 1)</h5> */}
            </div>
...
export default CurrWeekFourthClass;
