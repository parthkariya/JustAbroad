...
import "./LessonDetailsContent.css";
import {
  LessonDetailLesson,
  LessonDetailsVideos,
  TakeExercise,
...
const LessonDetailsContent = ({
  ...
  return (
    <div className="LessonDetailsContent_main">
      ...
      {getTab === 1 ? <LessonDetailLesson getlistinner={getlistinner} /> : null}
      {getTab === 2 ? (
        <LessonDetailsVideos getlistinner2={getlistinner2} />
      ) : null}
      {getTab === 4 ? <TakeQuizeLesson getlistinner4={getlistinner4} /> : null}
      {getExe === 1 ? <TakeExercise getlistinner3={getlistinner3} /> : null}
    </div>
  );
};
