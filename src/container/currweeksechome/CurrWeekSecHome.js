...
const CurrWeekSecClass = ({ getCurrWeekSecHome }) => {
        ...
        <div style={{ display: "flex", gap: "1rem", flexDirection: "column" }}>
          ...
          <div className="SectionTest_content_data_main">
            <div className="secTest_name_head">
              <h5>{getCurrWeekSecHome ? getCurrWeekSecHome.curriculum_writing_home_name : ""}</h5>
              {/* <h5>Writing - summarize Written Text - (C.W - 2 D -1)</h5> */}
            </div>

            {getCurrWeekSecHome?.data == 0 ? (
              <Link
                to="/currweeksecclasstestsec"
              ...
              <Link to="" className="section_test_btn_main">
          ...
          {/* <div className="SectionTest_content_data_main">
            ...
            <Link to="/SecReadingTest1" className="section_test_btn_main">
              <h5 className="btn resume_btn start_btn_responsive">
                Resume Test
              </h5>
            </Link>
          ...
          <div className="SectionTest_content_data_main">
            ...
            <div className="section_test_btn_main">
              <Link to="/SectionReadingViewReport">
                <h5 className="btn view_report_btn start_btn_responsive">
                  View Report
                </h5>
              </Link>
...
export default CurrWeekSecClass;
