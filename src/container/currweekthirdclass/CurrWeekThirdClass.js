...
const CurrWeekThirdClass = ({ getWriting }) => {
        ...
        <div style={{ display: "flex", gap: "1rem", flexDirection: "column" }}>
          ...
          <div className="SectionTest_content_data_main">
            <div className="secTest_name_head">
              {/* <h5>{getWriting ? getWriting.writing_name : ""}</h5> */}
              <h5>Reading-Fill in the Blanks - (C.W - 3 D - 1)</h5>
            </div>
...
export default CurrWeekThirdClass;
