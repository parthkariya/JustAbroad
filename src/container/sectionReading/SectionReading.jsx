...
import {
  ACCEPT_HEADER,
  reading_section1_count,
  reading_section2_count,
  reading_section3_count,
} from "../../utils/Constant";
import { useAuthContext } from "../../context/auth_context";

const SectionReading = ({ getReading }) => {
  ...
  const handleSelect = (event) => {
    ...
    if (selectedValue === "option1") {
      navigate("/ReadingPart1");
    }
    if (selectedValue === "option2") {
      navigate("/ReadingPart2");
    }
    if (selectedValue === "option3") {
      navigate("/ReadingPart3");
    }
        ...
        <div style={{ display: "flex", gap: "1rem", flexDirection: "column" }}>
          <div className="SectionTest_content_data_main">
            <div className="secTest_name_head">
              <h5>{getReading ? getReading.reading_section : ""}</h5>
            </div>
            ...
            <div style={{ display: "flex", gap: "1rem" }}>
              {/* <select
                ...
                <option value="option4">Section 1</option>
                <option value="option5">Section 2</option>
                <option value="option6">Section 3</option>
              </select> */}
          ...
          <>
            <div
              ...
              <div
                ...
                <h2>Discount</h2>
                <p>
                  Enter a vailid coupon code to upgrade your current package or
                  add new pack.
                </p>
              </div>
