...
const CurrWeekFirstClass = ({ getListning }) => {
        ...
        <div style={{ display: "flex", gap: "1rem", flexDirection: "column" }}>
          <div className="SectionTest_content_data_main">
            <div className="secTest_name_head">
              <h5>{getListning ? getListning.curriculum_speaking_name : ""}</h5>
              {/* Speaking-Read Aloud - (C.W - 1 D - 1) */}
            </div>

            {getListning?.data == 0 ? (
              <Link
                to="/currweekfirstclasstestfirst"
...
export default CurrWeekFirstClass;
