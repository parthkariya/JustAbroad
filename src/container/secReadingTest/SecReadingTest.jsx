...
const SecReadingTest = ({ getReading }) => {
        ...
        <div style={{ display: "flex", gap: "1rem", flexDirection: "column" }}>
          ...
          <div className="SectionTest_content_data_main">
            <div className="secTest_name_head">
              <h5>{getReading ? getReading.reading_name : ""}</h5>
            </div>
            <div className="SectionTest_content_data_num_main">
              <div className="SectionTest_content_data_num_inner">
                <div>{getReading ? getReading.total_que : ""}</div>
                <div>Total</div>
              </div>
              <div className="verticle_line"></div>
              <div className="SectionTest_content_data_num_inner">
                <div>{getReading ? getReading.attempt : ""}</div>
                <div>Attempts</div>
              </div>
              <div className="verticle_line"></div>
              <div className="SectionTest_content_data_num_inner">
                <div>{getReading ? getReading.correct : ""}</div>
                <div>Correct</div>
              </div>
              <div className="verticle_line"></div>
