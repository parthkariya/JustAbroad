...
const CurrWeekThirdHome = ({ getCurrWeekThirdHome }) => {
        ...
        <div style={{ display: "flex", gap: "1rem", flexDirection: "column" }}>
          ...
          <div className="SectionTest_content_data_main">
            <div className="secTest_name_head">
              <h5>
                {getCurrWeekThirdHome
                  ? getCurrWeekThirdHome.curriculum_reading_home_name
                  : ""}
              </h5>
              {/* Reading-Fill in the Blanks - (C.W -3 D -1) */}
            </div>
            <div className="SectionTest_content_data_num_main"></div>
            ...
            {getCurrWeekThirdHome?.data == 0 ? (
              <Link
                to="/CurrWeekReadingHomeworkTest"
          ...
          {/* <div className="SectionTest_content_data_main">
            ...
            <Link to="/SecWritingTest1" className="section_test_btn_main">
              <h5 className="btn resume_btn start_btn_responsive">
                Resume Test
              </h5>
            </Link>
          ...
          <div className="SectionTest_content_data_main">
            ...
            <div className="section_test_btn_main">
              <Link to="/SectionWritingViewReport">
                <h5 className="btn view_report_btn start_btn_responsive">
                  View Report
                </h5>
              </Link>
...
export default CurrWeekThirdHome;
