...
import { ACCEPT_HEADER, add_reading, add_reading_section1, reading_section1_count, view_reading } from "../../utils/Constant";
...
const ReadingPart1 = () => {
  ...
  const AddReadinging = async () => {
    ...
    axios
      .post(add_reading_section1, formdata, {
        headers: {
