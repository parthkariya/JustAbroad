...
import {
  ACCEPT_HEADER,
  add_listening_queries,
  view_listening_queries,
  view_listening_report,
} from "../../utils/Constant";
...
const SectionViewReport = () => {
  ...
  const getListeningReportApi = async () => {
    setloading(true);
  ...
  const viewListQueriesAPi = async () => {
    setloading(true);
    const Token = await localStorage.getItem("is_token");
    const Courseid = await localStorage.getItem("courseid");
    ...
    axios
      .post(view_listening_queries, formdata, {
        headers: {
          Accept: ACCEPT_HEADER,
          Authorization: "Bearer " + JSON.parse(Token),
        },
  ...
  const PostRaiseQuery = async () => {
    if (subject === "") {
      ...
      axios
        .post(add_listening_queries, formdata, {
          headers: {
            Accept: ACCEPT_HEADER,
            Authorization: "Bearer " + JSON.parse(Token),
          },
        ...
        <div className="prog_parts sec_test_prog_parts">
          <div className="prog_part1 sec_prog_part1">
            <div className="prog_digit_main">
              <h5 className="prog_digit_head">Listening Session 2</h5>
              <div
                style={{
                  width: "100%",
                  height: "80px",
            ...
            <div className="prog_details_main">
              ...
              {/* <BarChart /> */}
              <SecViewReportBarChart getlist={getlist} />
          ...
          <div className="table_support_main_mainn">
            <div className="table_support_main table_support_main_respo">
              ...
              <div className="loader"></div>
                      ...
                      <>{
                        getlistview && getlistview.length > 0 ? getlistview.map((item, index) => {
                          return (
        ...
        <>
          ...
          <div className="model_sizing">
            ...
            <div>
              ...
              <div>
                <textarea
                  style={{ width: "100%", height: "90px", border: "2px solid" }}
                  value={message}
                  onChange={(e) => {
