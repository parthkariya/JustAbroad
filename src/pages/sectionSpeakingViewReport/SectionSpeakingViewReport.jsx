...
import {
  ACCEPT_HEADER,
  add_speaking_queries,
  view_speaking_queries,
  view_speaking_report,
} from "../../utils/Constant";
...
const SectionSpeakingViewReport = () => {
  ...
  useEffect(() => {
    viewSpeakingQueriesAPi();
    getSpeakingReportApi();
  }, []);
      ...
      .then((res) => {
        if (res.data.status === "Token is Expired") {
          ...
          if (res.data.success === 1) {
            ...
            SetListAnswer2(res.data.answer.audio_full_path);
  ...
  const viewSpeakingQueriesAPi = async () => {
    setloading(true);
    const Token = await localStorage.getItem("is_token");
    const Courseid = await localStorage.getItem("courseid");
    ...
    axios
      .post(view_speaking_queries, formdata, {
        headers: {
          Accept: ACCEPT_HEADER,
          Authorization: "Bearer " + JSON.parse(Token),
        },
  ...
  const PostRaiseQuery = async () => {
    if (subject === "") {
      ...
      axios
        .post(add_speaking_queries, formdata, {
          headers: {
            Accept: ACCEPT_HEADER,
            Authorization: "Bearer " + JSON.parse(Token),
          },
    ...
    <div style={{ padding: "1.5rem" }}>
                  ...
                  <div className="prog_detail_table_main_mainn22">
                    <div className="prog_detail_table_main prog_detail_table_main_respo">
                      <div className="prog_table_head prog_table_head22">
                        <p
                          className="prog_table_head_txt1 sect_prog_table_head_txt1"
                          style={{ minWidth: "75px", textAlign: "center" }}>
                          Q.No
                        </p>
                        <p
                          className="prog_table_head_txt sect_prog_table_head_txt2"
                        ...
                        <p
                          className="prog_table_head_txt sect_prog_table_head_txt1"
                          style={{ Width: "150px" }}>
                          Play Video & Audio
                        </p>
                      </div>
                      <div className="prog_table_inner prog_table_inner22">
                        <span
                          className="prog_table_head_txt sect_prog_table_head_txt"
      ...
      <ReactModal
        ...
        <>
          ...
          <hr />
          <div className="model_sizing_video">
...
export default SectionSpeakingViewReport;
